...
namespace Core.Data
{
    ...
    {
        //数据库连接字符串
        public static string Conn = "server=192.168.1.101;Port=3336;user id=oadb;password=123456;database=TD_OA;Convert Zero Datetime=True;";
        /// <summary>
        ...
        public static T ExecuteObject<T>(string commandText)
        {
            DataSet dataSet = GetDataSet(commandText, null);
        ...
        public static IList<T> ExecuteObjectList<T>(string commandText)
        {
            DataSet dataSet = GetDataSet(commandText);
            if (CheckedDataSet(dataSet))
            {
